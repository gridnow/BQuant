...
async function getAllContracts() {
    return axios.get('https://fapi.binance.com/fapi/v1/exchangeInfo').then((ret) => {
        let f = ret.data.symbols.filter(s=> s.contractType == "PERPETUAL");
        return {data: f};
...
class BianAPI extends EventEmitter  {
    constructor(test=false) {
        ...
        // WSH
        this.apiKey = 'Cm2BVgxMrCrExQJFPU6sMpXzORosMZhjcZk7ZEGkjTyUdQGiE34pJzW2U1tC5uYs';
        this.apiSec = 'AnwSBGNGEkvz8ebe6GNxy0Xgf2L6H9rtSzGtcG4UZroopwHA7DyGEt19h3nXJC5P';
        
        if (test) {
            this.baseUrl = 'https://testnet.binancefuture.com';
            this.wsUrl = 'wss://stream.binancefuture.com/ws/';
            this.apiKey = 'fa3f33eb8df523df95263347b6bb83611a7826b588644992f8f752766adade93';
            this.apiSec = 'b65c073cbb856632f97742648a9f62041c4ded73dee14bdd210743543248712d';
        }
    ...
    handleAccountMessageStream(msg) {
        const { e } = msg;
        console.log("handleAccountMessageStream  ", JSON.stringify(msg));
        if (e == 'ACCOUNT_UPDATE') {
    ...
    async getLatestUp(time='15m') {
        try {
            return axios.get(`http://47.56.249.254:50004/blist?time=${time}&needjson=1&orderby=0`).then(ret => {
